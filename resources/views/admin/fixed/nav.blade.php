            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="{{route('specifications.index')}}">
                        <i class="ni ni-bullet-list-67 text-red"></i> Specifications
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="{{route('inventories.index')}}">
                        <i class="ni ni-bullet-list-67 text-red"></i> Inventories
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="{{route('countries.index')}}">
                        <i class="ni ni-bullet-list-67 text-red"></i> Countries
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="{{route('cities.index')}}">
                        <i class="ni ni-bullet-list-67 text-red"></i> Cities
                    </a>
                </li>
                <li class="nav-item">
