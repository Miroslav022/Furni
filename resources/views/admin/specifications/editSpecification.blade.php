                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Edit specification</h3>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="specification" id="input-username"
                                                   class="form-control form-control-alternative" value="{{$specification->specification}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-end">
                                    <button class="btn btn-success">Edit specification</button>
                                </div>
